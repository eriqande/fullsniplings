...
`prep_all_variables`.  Here we prep all the variables for the mykiss data set that has `r dim(fs_dev_test_data$mykiss_genos)[1]` individuals typed at `r dim(fs_dev_test_data$mykiss_genos)[2]/2` SNPs.
```{r}
