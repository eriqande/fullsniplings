...
cc <- chinook_chain
for(i in 0:1156) {
grab <- gibbs_update_one_indiv_in_place(FSL = cc$FSL, IFS = cc$IFS, LMMI = cc$LMMI, LMMFS = cc$LMMFS, PMMFS = cc$PMMFS, KidProngs = cc$KidProngs, Pile = cc$Pile, MatPile = cc$MatPile, AFSL = cc$AFSL, Gfreqs = cc$Gfreqs, UPG = cc$UPG, TP = cc$TP, IndLiks = cc$IndLiks, Ind = i)
cc$Pile = grab[[8]]
cc$MatPile = grab[[9]]
}
table(sapply(cc$FSL, function(x) length(x$Indiv)))
```
